<template>
  <div class="redirect-page">
    <div class="content-wrapper">
      <h1>Register on HerVest</h1>
      <p v-if="redirecting">Redirecting to store...</p>
      <div v-else class="desktop-view">
        <p>Download the HerVest app to register with referral code: <strong>{{ code }}</strong></p>
        <StoreButtons />
      </div>
    </div>
  </div>
...
export default {
  ...
  mounted() {
    ...
    const redirectUrl = getRedirectUrl(userAgent, { code: this.code, type: 'register' })
