      ...
      <div class="contact-block">
        <div class="contact-header-block">
          <div class="contact-header-inner">
            ...
            <h1 class="email">
              <a
                href="mailto:hello@hervest.ng"
                class="email-link"
              ><span class="pink-text"><strong>hello</strong></span>@hervest.ng</a>
            </h1>
          </div>
          <div class="contact-header-inner">
        ...
        <div class="contact-form-block w-form">
          <form
            v-if="submitStatus === 'initial' || submitStatus === 'failed'"
            id="email-form"
            ref="contactform"
            class="contact-form"
          ...
          >
            <input
              v-model="formData.template_params.contact_number"
              type="hidden"
              name="contact_number"
            >
            <input
              v-model="formData.template_params.to_name"
              type="hidden"
              name="to_name"
            >
            <div class="w-row">
              <div class="left-column w-col w-col-6">
                <input
                  id="First-Name"
                  v-model="formData.template_params.first_name"
                  type="text"
              ...
              <div class="right-column w-col w-col-6">
                <input
                  id="Last-Name"
                  v-model="formData.template_params.last_name"
                  type="text"
                  class="form-field w-input"
                  maxlength="256"
                  name="last_name"
            ...
            <input
              id="Email-Address"
              v-model="formData.template_params.user_email"
              type="email"
              class="form-field w-input"
              maxlength="256"
              name="user_email"
            ...
            ><textarea
              id="Message-2"
              v-model="formData.template_params.message"
