<template>
  <div class="nav">
    ...
    <div class="nav-link-wrapper">
      ...
      <div class="w-embed" />
      <div class="button-wrapper menu" :class="{ home: isHomePage }">
        <a class="button google-play w-inline-block"
          href="https://play.google.com/store/apps/details?id=com.hervest&amp;hl=en" target="_blank" />
        <a class="button app-store w-inline-block" href="https://apps.apple.com/ng/app/hervest/id1509714516"
          target="_blank" />
      </div>
    </div>
    <div class="hamburger">
      <div class="hamburger-lottie" data-animation-type="lottie" data-autoplay="0" data-default-duration="4"
        data-direction="1" data-duration="0" data-is-ix2-target="1" data-ix2-initial-state="24" data-loop="0"
        data-renderer="svg" data-src="/documents/purple-hamburger.json"
